...
- Name: create-builder.spec.ts >> Create Builder >> should create a new builder successfully
- Location: tests\e2e\create-builder.spec.ts:19:7
...
Locator: getByRole('row', { name: 'CreateE2E 1784637602430 571' })
Expected: visible
Timeout: 5000ms
...
Call log:
  ...
  - waiting for getByRole('row', { name: 'CreateE2E 1784637602430 571' })
...
Locator: getByRole('row').filter({ has: getByTestId('builder-name').filter({ hasText: 'CreateE2E 1784637602430 571' }) }).getByText('Inactive', { exact: true })
Expected: visible
Timeout: 10000ms
Error: element(s) not found
...
Call log:
  ...
  - waiting for getByRole('row').filter({ has: getByTestId('builder-name').filter({ hasText: 'CreateE2E 1784637602430 571' }) }).getByText('Inactive', { exact: true })
