...
Locator: getByRole('row', { name: 'CreateE2E 1784637603423 79' })
Expected: visible
Timeout: 5000ms
...
Call log:
  ...
  - waiting for getByRole('row', { name: 'CreateE2E 1784637603423 79' })
...
Locator: getByRole('row').filter({ has: getByTestId('builder-name').filter({ hasText: 'CreateE2E 1784637603423 79' }) }).getByText('Inactive', { exact: true })
Expected: visible
Timeout: 10000ms
Error: element(s) not found
...
Call log:
  ...
  - waiting for getByRole('row').filter({ has: getByTestId('builder-name').filter({ hasText: 'CreateE2E 1784637603423 79' }) }).getByText('Inactive', { exact: true })
