...
Locator: getByText('Are you sure you want to deactivate this builder?')
Expected: visible
Error: strict mode violation: getByText('Are you sure you want to deactivate this builder?') resolved to 20 elements:
    1) <p class="text-sm text-muted-foreground whitespace-pre-wrap">Are you sure you want to deactivate this builder?</p> aka getByText('Are you sure you want to').first()
    2) <p class="text-sm text-muted-foreground whitespace-pre-wrap">Are you sure you want to deactivate this builder?</p> aka getByText('Are you sure you want to').nth(1)
    3) <p class="text-sm text-muted-foreground whitespace-pre-wrap">Are you sure you want to deactivate this builder?</p> aka getByText('Are you sure you want to').nth(2)
    4) <p class="text-sm text-muted-foreground whitespace-pre-wrap">Are you sure you want to deactivate this builder?</p> aka getByText('Are you sure you want to').nth(3)
    5) <p class="text-sm text-muted-foreground whitespace-pre-wrap">Are you sure you want to deactivate this builder?</p> aka getByText('Are you sure you want to').nth(4)
    6) <p class="text-sm text-muted-foreground whitespace-pre-wrap">Are you sure you want to deactivate this builder?</p> aka getByText('Are you sure you want to').nth(5)
    7) <p class="text-sm text-muted-foreground whitespace-pre-wrap">Are you sure you want to deactivate this builder?</p> aka locator('dialog:nth-child(193) > .flex.flex-col > .text-sm')
    8) <p class="text-sm text-muted-foreground whitespace-pre-wrap">Are you sure you want to deactivate this builder?</p> aka locator('dialog:nth-child(194) > .flex.flex-col > .text-sm')
    9) <p class="text-sm text-muted-foreground whitespace-pre-wrap">Are you sure you want to deactivate this builder?</p> aka locator('dialog:nth-child(195) > .flex.flex-col > .text-sm')
    10) <p class="text-sm text-muted-foreground whitespace-pre-wrap">Are you sure you want to deactivate this builder?</p> aka locator('dialog:nth-child(196) > .flex.flex-col > .text-sm')
    ...

Call log:
  - Expect "toBeVisible" with timeout 5000ms
  - waiting for getByText('Are you sure you want to deactivate this builder?')
...
Locator: getByRole('row').filter({ has: getByTestId('builder-name').filter({ hasText: 'StatusToggleE2E 1784637588710 497' }) }).getByText('Inactive', { exact: true })
Expected: visible
Timeout: 10000ms
...
Call log:
  ...
  - waiting for getByRole('row').filter({ has: getByTestId('builder-name').filter({ hasText: 'StatusToggleE2E 1784637588710 497' }) }).getByText('Inactive', { exact: true })
...
- main:
  ...
  - main:
    ...
    - table:
      ...
      - rowgroup:
        - row "CR CreateE2E 1784637603423 79 createe2e-1784637603423-79 - 2020 Active Open menu":
          ...
          - cell "Open menu":
            - button "Open menu"
        - row "ED EditE2E 1784637588862 866 edite2e-1784637588862-866 - 2020 Active Open menu":
          - cell "ED EditE2E 1784637588862 866 edite2e-1784637588862-866"
          - cell "-"
          - cell "2020"
          - cell "Active"
          - cell "Open menu":
            - button "Open menu"
        - row "CR CreateE2E 1784637602430 571 createe2e-1784637602430-571 - 2020 Active Open menu":
        ...
        - row "SE Search1_Alpha 1784637588311 800 search1-alpha-1784637588311-800 - 2020 Active Open menu":
          ...
          - cell "Open menu":
            - button "Open menu"
        - row "LO LogoE2E 1784637588799 994 logoe2e-1784637588799-994 - 2020 Active Open menu":
          - cell "LO LogoE2E 1784637588799 994 logoe2e-1784637588799-994"
          - cell "-"
          - cell "2020"
          - cell "Active"
          - cell "Open menu":
        ...
        - row "SE Search2_Beta 1784637036158 555 search2-beta-1784637036158-555 - 2020 Inactive Open menu":
          ...
          - cell "Open menu":
            - button "Open menu"
        - row "SE Search1_Alpha 1784637036158 159 search1-alpha-1784637036158-159 - 2020 Inactive Open menu":
          - cell "SE Search1_Alpha 1784637036158 159 search1-alpha-1784637036158-159"
          - cell "-"
          - cell "2020"
          - cell "Inactive"
          - cell "Open menu":
            - button "Open menu"
    - text: Showing 1 to 10 of 84 items
