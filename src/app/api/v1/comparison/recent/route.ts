...
// Recent behaves similarly to history but we might want to restrict it or default to a smaller limit
export async function GET(req: NextRequest) {
  try {
    ...
    // Default limit for recent is smaller if not provided
    if (!searchParams.limit) searchParams.limit = '5';
