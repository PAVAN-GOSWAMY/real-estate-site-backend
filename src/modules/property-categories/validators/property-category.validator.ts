...
export const updatePropertyCategorySchema = createPropertyCategorySchema.partial().strict();

export const propertyCategoryFilterSchema = paginationSchema.extend({
